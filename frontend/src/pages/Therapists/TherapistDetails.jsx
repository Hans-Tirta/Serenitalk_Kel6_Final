            ...
            <div className='md:col-span-2'>
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <h3 className='text-textColor text-[22px] leading-9 mt-3 font-bold'>{name}</h3>
              ...
              <div className="mt-[50px]">
                {tab === 'about' && <TherapistAbout name={name} about={about} qualifications={qualifications} experiences={experiences} />}
