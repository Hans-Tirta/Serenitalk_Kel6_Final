...
const TherapistAbout = ({name, about, qualifications, experiences}) => {
    return (
        <div>
            <div>
                <h3 className='text-[20px] leading-[30px] text-textColor font-semibold flex item-center gap-2'>About of
                    <span className="text-headingColor font-bold text-[24px]">{name}</span>
                </h3>
            ...
            <div className='mt-12'>
                ...
                <ul className="pt-4 md:p-5">
                    ...
                    <div>
                        <span className='text-headingColor text-[15px] leading-6 font-semibold'>{formatDate(item.startingDate)} - {" "} {formatDate(item.endingDate)}</span>
            ...
            <div className="mt-12">
                ...
                <ul className="grid sm:grid-cols-2 gap-[30px] pt-4 md:p-5">
                    ...
                    {experiences?.map((item, index)=>(<li key={index} className='p-4 rounded bg-[#EDFFDC]'>
                        ...
                        <p className='text-[14px] leading-6 font-medium text-textColor'>{item.hospital}</p>
                    </li>))}
